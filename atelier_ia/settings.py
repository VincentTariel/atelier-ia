...
SECRET_KEY = 'django-insecure-x&fsn%a)-i3ei!fmw1ytorxtq0h0h(0*b48#@w*spdre)#2*nz'
...
ALLOWED_HOSTS = ["https://atelier-ia.ovh", "atelier-ia.ovh", "www.atelier-ia.ovh","51.161.32.145", "localhost", "127.0.0.1"]
