...
{\footnotesize\itshape Docteur de l'École Polytechnique\\
...
Vous avez peut-être déjà essayé une intelligence artificielle. Vous avez ouvert
ChatGPT ou Claude, posé une question — et obtenu une réponse polie, générique,
\textit{à côté} du sujet. Vous avez refermé l'onglet en pensant
\textit{« ce n'est pas pour moi »}.

C'est l'objection la plus fréquente que j'entends à Nouméa. Et c'est presque
toujours la même cause~: l'outil utilisé brut, sans contexte, ne vaut pas
grand-chose pour un professionnel. Bien encadré, le même outil vous rend
des heures par jour.
...
Maître Calonne tient un cabinet généraliste à Nouméa~: contentieux civil,
...
Maître Calonne crée un Project nommé \textit{« Cabinet — Rédaction »}~:
...
Tu es l'assistant de rédaction du cabinet Calonne à Nouméa. Ton rôle est
...
Lundi matin, Maître Calonne sort de RDV avec une cliente. Elle a témoigné
...
Vincent Tariel — Docteur en informatique de l'École Polytechnique
